<%@ Page Title="" Language="C#" MasterPageFile="~/Public/Admin.master" AutoEventWireup="true"
    CodeFile="goodsispass.aspx.cs" Inherits="Admin_goodsispass" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <center>
                <div style="text-align: center; min-height: 300px; margin-top: 10px; float: left;
                    clear: right;">
                    <div style="text-align: center; min-height: 300px; margin-left: 5px; margin-top: 0px;
                        float: left; clear: right;">
                        <asp:GridView ID="gdvgoodspass" runat="server" AutoGenerateColumns="False" DataSourceID="sdsgoodsmana"
                            DataKeyNames="phone_id" BackColor="White" BorderColor="#CC9966" BorderStyle="None"
                            BorderWidth="1px" CellPadding="4" Width="712px" OnRowDataBound="gdvgoodspass_RowDataBound"
                        ...
                        <asp:SqlDataSource ID="sdsgoodsmana" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationServices %>"
                            SelectCommand="SELECT * FROM [phone_state_set_view1] where mobilestate='正在热销'">
                        </asp:SqlDataSource>
                    </div>
                </div>
