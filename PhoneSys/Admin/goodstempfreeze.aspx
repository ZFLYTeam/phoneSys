<%@ Page Title="" Language="C#" MasterPageFile="~/Public/Admin.master" AutoEventWireup="true"
    CodeFile="goodstempfreeze.aspx.cs" Inherits="Admin_goodstempfreeze" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <center>
        <div style="text-align: center; min-height: 300px; margin-top: 20px; float: left;
            clear: right;">
            <div style="text-align: center; min-height: 300px; margin-left: 15px; margin-top: 20px;
                float: left; clear: right;">
                <asp:GridView ID="gdvgoodstemfreeze" runat="server" AutoGenerateColumns="False" DataSourceID="sdsgoodsmana"
                    DataKeyNames="phone_id" BackColor="White" BorderColor="#CC9966" BorderStyle="None"
                    BorderWidth="1px" CellPadding="4" Width="712px" OnRowDataBound="gdvgoodstemfreeze_RowDataBound"
                ...
                <asp:SqlDataSource ID="sdsgoodsmana" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationServices %>"
                    SelectCommand="SELECT * FROM [phone_state_set_view1] where mobilestate='暂时冻结'">
                </asp:SqlDataSource>
            </div>
        </div>
        <div style="height: 40px; width: 100%; float: left;">
            ...
            <asp:Button ID="btngoodtemfreeze" runat="server" OnClick="btngoodtemfreeze_Click"
                Text="解除冻结" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnfreezelong" runat="server" Text="永久冻结" Width="64px" OnClick="btnfreezelong_Click" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
    </center>
</asp:Content>
