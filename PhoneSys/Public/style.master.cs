...
public partial class Public_style : System.Web.UI.MasterPage
{
    ...
    {
        if (txtUserName.Text != "" && txtRealName.Text != "" && txtQuestion.Text != "" && txtNewPwd.Text != "" && txtTelPhone.Text != "" && txtEmail.Text != "" && txtAnswer.Text != "" && txtAddress.Text != "" && txtAckPwd.Text != "")
        {
            ...
            int result = registerDA.P_INSERT_USER_ROLES("/", txtUserName.Text, "", Password, salt, txtEmail.Text, txtQuestion.Text, txtAnswer.Text, 1, DateTime.UtcNow, DateTime.Now, 0, 1, roleId, txtRealName.Text, txtTelPhone.Text, txtAddress.Text);
