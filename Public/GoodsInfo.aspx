<%@ Page Title="" Language="C#" MasterPageFile="~/Public/style.master" AutoEventWireup="true" CodeFile="GoodsInfo.aspx.cs" Inherits="Public_GoodInfo" %>
...
<div id="content">
    <div id="right">
         ...
         店铺：<asp:LinkButton ID="lbtnSellerName" runat="server" 
                         ForeColor="Blue"  onclick="lbtnSellerName_Click"></asp:LinkButton></div>
         ...
         <div id="rt">
                <div id="rt1">
                   <table align="center" width="100%" cellpadding="0" cellspacing="0" style="height:25px;text-align:center;">
                       <tr><td>
                    ...
                    <table class="style1">
                        ...
                        <tr>
                            ...
                            <asp:Label ID="lblShow1" runat="server" Text="商品数量："></asp:Label>
                                ...
                                <asp:TextBox ID="txtNum" runat="server" Height="20px" Width="40px" 
                                    ontextchanged="txtNum_TextChanged">1</asp:TextBox>
                                ...
                                </asp:Label><asp:Label ID="lblShow6" runat="server" Text="抱歉，此商品已下架！" 
                        ...
                        <tr>
                            ...
                            <td style="line-height:20px;">
                                <asp:ImageButton ID="ibtnMoveCart" runat="server" 
                                    ImageUrl="~/images/加入购物车.jpg" onclick="ibtnMoveCart_Click" />
                                <asp:ImageButton ID="ibtnBuyNow" runat="server" 
                                    ImageUrl="~/images/立即购买.jpg" onclick="ibtnBuyNow_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td class="style10">
                            ...
                            <td class="style11">
                                <asp:ImageButton ID="ibtnCollect" runat="server" 
                                    ImageUrl="~/images/Collect.jpg" onclick="ibtnCollect_Click" />
                            </td>
                        </tr>
                    </table>
                 </div> 
    ...
    <div class="wrap">
      <ul id="tab_t">
    <li class="act">
        <asp:Button ID="btnDetail" runat="server" BorderStyle="None" 
            onclick="btnDetail_Click" Text="商品详情" Width="98px" CssClass="btnDetail" />
          </li>
    <li>
        <asp:Button ID="btnEstimate" runat="server" BorderStyle="None"
            onclick="btnEstimate_Click" Text="商品评价" Width="100px" 
            CssClass="btnEstimateCss" />
          </li>
  </ul>
 ...
 <asp:Panel ID="Panel2" runat="server">
    ...
    <div class="estimate">
        ...
        <asp:DataList ID="dlEstimate" runat="server"  RepeatColumns="1" 
                RepeatDirection="Horizontal" Height="200px" Width="900px" 
            onitemcommand="dlEstimate_ItemCommand" 
            onitemdatabound="dlEstimate_ItemDataBound" >
            <FooterTemplate>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         ...
         <ItemTemplate>
             ...
             <table class="style12" 
                 ...
                 <tr>
                     <td class="style16">
                         <asp:Label ID="lblTime" runat="server" ForeColor="#999999" 
                             Text='<%# Eval("esttime") %>'></asp:Label>
                     </td>
                     <td class="style18">
