    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div class="center_photo_info">
            ...
            <table class="style12">
                <tr>
                    <td>
                        <asp:LinkButton ID="lbtnName1" runat="server" ForeColor="White"></asp:LinkButton>
                    </td>
                </tr>
            </table>
            ...
            <table class="style1">
                <tr>
                    <td style="background-color: #FF5050">
                        <asp:LinkButton ID="lbtnName2" runat="server" ForeColor="White"></asp:LinkButton>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="center_photo_info">
            <table class="style11" style="background-color: #FF9428; text-align: center;">
                <tr>
                    <td>
                        <asp:LinkButton ID="lbtnName3" runat="server" ForeColor="White"></asp:LinkButton>
                    </td>
                </tr>
            </table>
        </div>
