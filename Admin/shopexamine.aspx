...
<div style="text-align:center;height:50px;width:80%;">
    ...
    <asp:DropDownList ID="ddlexamtype" class="selectitem" runat="server" Font-Size="Medium" Width="100px"
        Height="34px">
    ...
    <asp:TextBox ID="txtexamcondition" runat="server" Height="30px" Width="260px" 
